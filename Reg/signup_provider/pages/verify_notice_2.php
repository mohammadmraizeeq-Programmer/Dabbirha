...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/verify_notice_2_style.css?v=2">
</head>
<body>
    <div class="verification-card">
        ...
        <div class="alert-info">
            ...
            <strong>Note:</strong> If you don't see the email, check your spam folder. You need to verify your email before you can access your dashboard.
        </div>
    ...
    <div class="timer" id="timer">
        ...
        <div class="actions">
        <a href="/Dabbirha/index.php" class="btn btn-outline-primary">
                <i class="ri-home-line"></i>
                Bacck to home
            </a>
         
        
            <a href="../../signup_provider/pages/provider-registration.php?step=5&email=<?php echo urlencode($email); ?>" class="btn btn-dashboard">
    ...
    <script src="../assets/js/verify_notice_2_scripts.js?v=<?php echo time(); ?>"></script>
</body>
</html>